<template>
  <section id="contato" class="py-20 bg-white dark:bg-gray-950">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          Vamos conversar sobre seu próximo projeto? Estou disponível para freelances e oportunidades de trabalho.
        </p>
      </div>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8">
          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <div class="flex gap-4">
              <button
                ...
                class="flex-1 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-medium py-3 px-6 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
              ...
              <a
                ...
                target="_blank"
                class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
              >
          ...
          <!-- Mensagem de Sucesso -->
          <div v-if="showSuccess" class="mt-6 p-4 bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-700 rounded-lg">
